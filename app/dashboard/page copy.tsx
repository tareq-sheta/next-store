...
export default function DashboardPage() {
  ...
  const numberOfRecentOrders = 5;
  const numberOfTopProducts = 4;
    ...
    try {
      ...
      setRecentOrders(
        [...orders]
          ...
          .slice(0, numberOfRecentOrders),
      );
      setTopProducts(products.slice(0, numberOfTopProducts));
      setRecentUsers(
        [...users]
          .sort(
            (a, b) =>
        ...
        >
          <div className="lg:col-span-3 bg-white border border-gray-100 rounded-xl p-4 flex flex-col min-h-0">
            ...
            {loading ? (
              ...
              <div className="flex flex-col min-h-0 flex-1">
                ...
                <div className="flex-1  overflow-x-hidden overflow-y-hidden divide-y divide-gray-50 ">
          ...
          <div className="lg:col-span-3 bg-white border border-gray-100 rounded-xl p-4 flex flex-col min-h-0">
            ...
            {loading ? (
              ...
              /* This div is for dashboard products listing */
              <div className="flex flex-col min-h-0 flex-1">
